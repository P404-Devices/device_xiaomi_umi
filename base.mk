...
#FINGERPRINT
FINGERPRINT := android.hardware.biometrics.fingerprint@2.1-service.xiaomi_umi

#FOD
FOD := vendor.lineage.biometrics.fingerprint.inscreen@1.0-service.xiaomi_umi
...
#VIBRATOR
VIBRATOR := vendor.qti.hardware.vibrator.service.xiaomi_umi
